    ...
    <div className="featured">
      ...
      <div className="container">
        ...
        <div className="span-2 right-img-details">
          <p>
            A beautiful family home with a full-size pool. Spacious and
            luxurious home is located in Colorado. Including media room, workout
      ...
      <div className="container">
        ...
        <div className="span-2 right-img-details order-7">
          <p>
            Modern day home in big city with garage. Spacious and luxurious home
            located in Texas. Including media room, workout facility, and
            built-in sauna.
          </p>
          <button className="btn">View Listing</button>
        </div>
